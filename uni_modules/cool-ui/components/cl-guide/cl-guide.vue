<template>
    <view class="cl-guide">
        ...
        >
            <!-- 显示区域 -->
            <!-- @ts-ignore -->
            <view class="cl-guide__display" :style="([display.style, step.style] as any)" @tap="onTap"></view>
...
/**
 * @description 步骤引导
 * @property {Number} modelValue 当前步骤序号
...
import { computed, defineComponent, getCurrentInstance, nextTick, reactive, ref, watch } from "vue"
