...
/**
 * @description 倒计时
 * @property {String} simple 是否精简：为00时自动隐藏
 ...
 * @property {Object} textStyle 分隔符样式
...
export default defineComponent({
	...
	setup(props, { emit }) {
		...
		function countDown() {
			...
			let arr: any[] = props.format.split(/[{,}]/).filter(Boolean).map(e => {
				return {
					value: d[e] ? d[e] : e,
					ch: d[e] === undefined
				}
